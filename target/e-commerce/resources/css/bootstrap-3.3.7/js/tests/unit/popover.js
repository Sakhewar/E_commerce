$(function () {
  ...
  QUnit.test('should get title and content from attributes', function (assert) {
    assert.expect(4)
    var $popover = $('<a href="#" title="@mdo" data-content="loves data attributes (�?�｡◕‿‿◕｡)�?� ︵ ┻�?┻" >@mdo</a>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover()
      .bootstrapPopover('show')
    ...
    assert.strictEqual($('.popover .popover-content').text(), 'loves data attributes (�?�｡◕‿‿◕｡)�?� ︵ ┻�?┻', 'content correctly inserted')
